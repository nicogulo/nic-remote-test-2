...
function registerButtonHandlers() {
    ...
    document.getElementById('openWindowButton').addEventListener('click', function() {
        liff.openWindow({
            url: 'https://indfoodstation.herokuapp.com/', // Isi dengan Endpoint URL aplikasi web Anda
            external: true
        });
    });
    ...
    document.getElementById('sendMessageButton').addEventListener('click', function() {
        if (!liff.isInClient()) {
            ...
            liff.sendMessages([{
                'type': 'text',
                'text': "Hey, ada yang mau pesan nih!"
            }]).then(function() {
...
function simpanData() {
    ...
    if (!liff.isInClient()) {
        ...
        liff.sendMessages([{
            'type': 'text',
            'text': "Kakak "+nama+" memesan "+menu+" dengan jumlah "+jumlah+" porsi !"
        }]).then(function() {
            alert('Pesanan kak '+nama+' sebanyak '+jumlah+' porsi '+menu+' akan segera diproses');
        }).catch(function(error) {
            alert('Ada error nih');
        });
    }
...
function simpanEditData() {
    ...
    if (!liff.isInClient()) {
        ...
        liff.sendMessages([{
            'type': 'text',
            'text': "Orderan kak "+nama+" diubah jadi " +menu+ +jumlah "porsi"
        }]).then(function() {
